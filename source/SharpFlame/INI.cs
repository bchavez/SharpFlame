				...
				for (A = 0; A <= Properties.Count - 1; A++)
				{
					...
					switch (TranslatorResult)
					{
						case enumTranslatorResult.NameUnknown:
							...
							{
								ReturnResult.WarningAdd("Property name " + System.Convert.ToString(ControlChars.Quote) + Properties[A].Name + System.Convert.ToString(ControlChars.Quote) + " is unknown.");
							}
						...
						case enumTranslatorResult.ValueInvalid:
							...
							{
								ReturnResult.WarningAdd("Value " + System.Convert.ToString(ControlChars.Quote) + Properties[A].Value + System.Convert.ToString(ControlChars.Quote) + " for property name " + System.Convert.ToString(ControlChars.Quote) + Properties[A].Name + System.Convert.ToString(ControlChars.Quote) + " is not valid.");
							}
