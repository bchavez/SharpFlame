...
MessageBox.Show("Error: Assigning map to wrong main form.");
		...
		public void Load_Heightmap_Prompt()
		{
			...
			for (Y = 0; Y <= Math.Min(HeightmapBitmap.Height - 1, ApplyToMap.Terrain.TileSize.Y); Y++)
			{
				for (X = 0; X <= Math.Min(HeightmapBitmap.Width - 1, ApplyToMap.Terrain.TileSize.X); X++)
				{
					...
					ApplyToMap.Terrain.Vertices[X, Y].Height = (byte)Math.Min(Math.Round(System.Convert.ToDouble(((PixelColor.R) + PixelColor.G + PixelColor.B) / 3.0D)), byte.MaxValue);
				}
			}
		...
		public void Map_Resize(modMath.sXY_int Offset, modMath.sXY_int NewSize)
		{
			...
			if (Interaction.MsgBox("Resizing can\'t be undone. Continue?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
			{
				return;
			}
			...
			{
				if (Interaction.MsgBox("Warzone doesn\'t support map sizes above " + System.Convert.ToString(modProgram.WZMapMaxSize) + ". Continue anyway?", MsgBoxStyle.YesNo, "") != MsgBoxResult.Yes)
				{
					return;
				}
			}
		...
		public void btnHeightOffsetSelection_Click(System.Object sender, System.EventArgs e)
		{
			...
			for (Y = StartXY.Y; Y <= FinishXY.Y; Y++)
			{
				...
				{
					Map.Terrain.Vertices[X, Y].Height = (byte) (Math.Round(modMath.Clamp_dbl(System.Convert.ToDouble(Map.Terrain.Vertices[X, Y].Height + Offset), byte.MinValue, byte.MaxValue)));
					Pos.X = X;
					Pos.Y = Y;
		...
		public void tsbSelectionPaste_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (!(menuSelPasteHeights.Checked || menuSelPasteTextures.Checked || menuSelPasteUnits.Checked || menuSelPasteDeleteUnits.Checked || menuSelPasteGateways.Checked || menuSelPasteDeleteGateways.Checked))
			{
				return;
			}
			modMath.sXY_int Area = new modMath.sXY_int();
			...
			Area.X = Finish.X - Start.X;
			Area.Y = Finish.Y - Start.Y;
			Map.MapInsert(modProgram.Copied_Map, Start, Area, menuSelPasteHeights.Checked, menuSelPasteTextures.Checked, menuSelPasteUnits.Checked, menuSelPasteDeleteUnits.Checked, menuSelPasteGateways.Checked, menuSelPasteDeleteGateways.Checked);
		...
		private clsResult NoTile_Texture_Load()
		{
			...
			if (modBitmap.LoadBitmap(modProgram.EndWithPathSeperator((new Microsoft.VisualBasic.ApplicationServices.ConsoleApplicationBase()).Info.DirectoryPath) + "notile.png", ref Bitmap).Success)
			{
			...
			if (modBitmap.LoadBitmap(modProgram.EndWithPathSeperator((new Microsoft.VisualBasic.ApplicationServices.ConsoleApplicationBase()).Info.DirectoryPath) + "overflow.png", ref Bitmap).Success)
			{
			...
			else
			{
				...
				else
				{
					...
					if (Map.PathInfo.IsFMap)
					{
						...
						tsbSave.ToolTipText = "Quick save FMap to " + System.Convert.ToString(ControlChars.Quote) + quickSavePath + System.Convert.ToString(ControlChars.Quote);
		...
		public void btnHeightsMultiplySelection_Click(System.Object sender, System.EventArgs e)
		{
			...
			for (Y = StartXY.Y; Y <= FinishXY.Y; Y++)
			{
				for (X = StartXY.X; X <= FinishXY.X; X++)
				{
					Map.Terrain.Vertices[X, Y].Height = (byte) (Math.Round(modMath.Clamp_dbl(System.Convert.ToDouble(Map.Terrain.Vertices[X, Y].Height * Multiplier), byte.MinValue, byte.MaxValue)));
					Pos.X = X;
					Pos.Y = Y;
					Map.SectorGraphicsChanges.VertexAndNormalsChanged(Pos);
					Map.SectorUnitHeightsChanges.VertexChanged(Pos);
		...
		public void txtObjectPriority_LostFocus(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change priority of multiple objects?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					//SelectedObject_Changed()
					//todo
					return;
		...
		public void txtObjectHealth_LostFocus(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change health of multiple objects?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					//SelectedObject_Changed()
					//todo
					return;
		...
		public void btnDroidToDesign_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change design of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
			...
			{
				if (Interaction.MsgBox("Change design of a droid?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void cboDroidBody_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change body of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void cboDroidPropulsion_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change propulsion of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void cboDroidTurret1_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change turret of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void rdoDroidTurret0_CheckedChanged(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change number of turrets of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void cboDroidType_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			...
			if (Map.SelectedUnits.Count > 1)
			{
				if (Interaction.MsgBox("Change type of multiple droids?", (Microsoft.VisualBasic.MsgBoxStyle) (MsgBoxStyle.OkCancel | MsgBoxStyle.Question), "") != MsgBoxResult.Ok)
				{
					return;
				}
			}
		...
		public void HeightPickerL()
		{
			...
			txtHeightSetL.Text = modIO.InvariantToString_byte(System.Convert.ToByte(Map.Terrain.Vertices[MouseOverTerrain.Vertex.Normal.X, MouseOverTerrain.Vertex.Normal.Y].Height));
			txtHeightSetL.Focus();
...
MessageBox.Show("Error: Creating area failed.");
			...
			NewArea.SetPositions(new modMath.sXY_int(Map.Selected_Area_VertexA.X * modProgram.TerrainGridSpacing, Map.Selected_Area_VertexA.Y * modProgram.TerrainGridSpacing), new modMath.sXY_int(Map.Selected_Area_VertexB.X * modProgram.TerrainGridSpacing, Map.Selected_Area_VertexB.Y * modProgram.TerrainGridSpacing));
