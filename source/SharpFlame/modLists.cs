...
public object Current1
		    ...
		    IEnumerator IEnumerable.GetEnumerator()
		    {
		        return GetEnumerator();
					...
					private class ConnectedListItemList<ItemType, SourceType> : modLists.SimpleClassList<ConnectedListItem<ItemType, SourceType>> where ItemType : class where SourceType : class
					{
					    ...
					    IEnumerator IEnumerable.GetEnumerator()
					    {
					        return GetEnumerator();
								...
								public abstract class ConnectedListItem<ItemType, SourceType> where ItemType : class where SourceType : class
								{
									...
									abstract public ItemType Item {get;}
									abstract public SourceType Source {get;}
									abstract public bool CanAdd();
									abstract public void BeforeAdd(ConnectedList<ItemType, SourceType> NewList, int NewPosition);
									abstract public void BeforeRemove();
									abstract public void AfterRemove();
									abstract public void AfterMove(int NewPosition);
