...
namespace SharpFlame.Painters
{
    internal sealed class PainterFactory
    {
        public static void CreatePainterArizona()
        {
            ...
            NewBrush.Tiles_Straight.TileAdd(14, TileUtil.Bottom, 1);
            NewBrush.Tiles_Corner_In.TileAdd(16, TileUtil.BottomLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(15, TileUtil.BottomLeft, 1);
            ...
            NewBrush.Tiles_Straight.TileAdd(31, TileUtil.Top, 1);
            NewBrush.Tiles_Corner_In.TileAdd(33, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(32, TileUtil.TopLeft, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(27, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(28, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(29, TileUtil.BottomRight, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Red;
            NewBrush.Tiles_Straight.TileAdd(43, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(42, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(41, TileUtil.TopLeft, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(10, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(1, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(0, TileUtil.TopLeft, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Red;
            NewBrush.Tiles_Straight.TileAdd(34, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(36, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(35, TileUtil.TopLeft, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Brown;
            NewBrush.Terrain_Outer = Terrain_Yellow;
            NewBrush.Tiles_Straight.TileAdd(38, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(39, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(40, TileUtil.BottomRight, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Brown;
            NewBrush.Terrain_Outer = Terrain_Sand;
            NewBrush.Tiles_Straight.TileAdd(2, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(3, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(4, TileUtil.BottomRight, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Brown;
            NewBrush.Terrain_Outer = Terrain_Green;
            NewBrush.Tiles_Straight.TileAdd(24, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(26, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(25, TileUtil.TopLeft, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Red;
            NewBrush.Tiles_Straight.TileAdd(21, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(19, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(20, TileUtil.BottomRight, 1);
            App.Painter_Arizona.AddBrush(NewBrush);
        ...
        public static void CreatePainterUrban()
        {
            ...
            NewBrush.Tiles_Straight.TileAdd(23, TileUtil.Left, 1);
            NewBrush.Tiles_Straight.TileAdd(24, TileUtil.Top, 1);
            NewBrush.Tiles_Corner_In.TileAdd(25, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(26, TileUtil.TopLeft, 1);
            ...
            NewBrush.Tiles_Straight.TileAdd(13, TileUtil.Left, 1);
            NewBrush.Tiles_Straight.TileAdd(14, TileUtil.Bottom, 1);
            NewBrush.Tiles_Corner_In.TileAdd(16, TileUtil.BottomLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(15, TileUtil.BottomLeft, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(6, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(4, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(3, TileUtil.BottomRight, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Concrete;
            NewBrush.Terrain_Outer = Terrain_Gray;
            NewBrush.Tiles_Straight.TileAdd(9, TileUtil.Left, 1);
            NewBrush.Tiles_Straight.TileAdd(27, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(30, TileUtil.BottomLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(10, TileUtil.BottomLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(29, TileUtil.BottomLeft, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Blue;
            NewBrush.Tiles_Straight.TileAdd(33, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(34, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(35, TileUtil.BottomRight, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Orange;
            NewBrush.Terrain_Outer = Terrain_Green;
            NewBrush.Tiles_Straight.TileAdd(39, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(38, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(37, TileUtil.TopLeft, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Orange;
            NewBrush.Terrain_Outer = Terrain_Gray;
            NewBrush.Tiles_Straight.TileAdd(60, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(73, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(72, TileUtil.TopLeft, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Orange;
            NewBrush.Terrain_Outer = Terrain_Concrete;
            NewBrush.Tiles_Straight.TileAdd(71, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(76, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(75, TileUtil.BottomRight, 1);
            App.Painter_Urban.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Inner = Terrain_Gray;
            NewBrush.Terrain_Outer = Terrain_Green;
            NewBrush.Tiles_Straight.TileAdd(77, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(58, TileUtil.BottomLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(79, TileUtil.BottomLeft, 1);
            App.Painter_Urban.AddBrush(NewBrush);
        ...
        public static void CreatePainterRockies()
        {
            ...
            NewBrush.Tiles_Straight.TileAdd(31, TileUtil.Top, 1);
            NewBrush.Tiles_Corner_In.TileAdd(32, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(33, TileUtil.TopLeft, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Gravel;
            NewBrush.Tiles_Straight.TileAdd(2, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(3, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(4, TileUtil.TopLeft, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(26, TileUtil.Top, 1);
            NewBrush.Tiles_Corner_In.TileAdd(25, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(24, TileUtil.TopLeft, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(34, TileUtil.Right, 1);
            NewBrush.Tiles_Corner_In.TileAdd(35, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(36, TileUtil.BottomRight, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Gravel;
            NewBrush.Tiles_Straight.TileAdd(12, TileUtil.Bottom, 1);
            NewBrush.Tiles_Corner_In.TileAdd(10, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(11, TileUtil.BottomRight, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Tiles_Straight.TileAdd(67, TileUtil.Bottom, 1);
            NewBrush.Tiles_Corner_In.TileAdd(65, TileUtil.BottomRight, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(66, TileUtil.BottomRight, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            ...
            NewBrush.Terrain_Outer = Terrain_Dirt;
            NewBrush.Tiles_Straight.TileAdd(38, TileUtil.Left, 1);
            NewBrush.Tiles_Corner_In.TileAdd(40, TileUtil.TopLeft, 1);
            NewBrush.Tiles_Corner_Out.TileAdd(39, TileUtil.TopLeft, 1);
            App.Painter_Rockies.AddBrush(NewBrush);
            //road
            var Road_Road = new Road();
            Road_Road.Name = "Road";
