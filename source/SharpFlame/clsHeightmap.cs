...
namespace SharpFlame
{
	public class clsHeightmap
	{
		...
		public void Inflate(clsHeightmap Source, double NoiseFactor, double HeightMultiplier, int VariationReduction)
		{
			...
			Blank((Source.HeightData.SizeY - 1) * 2 + 1, System.Convert.ToInt32((Source.HeightData.SizeX - 1) * 2 + 1));
			...
			for (Y = 1; Y <= HeightData.SizeY - 2; Y += 2)
			{
				...
				{
					Mean = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToInt32(HeightData.Height[Y - 1, X - 1] + HeightData.Height[Y - 1, X + 1]) + HeightData.Height[Y + 1, X - 1] + HeightData.Height[Y + 1, X + 1]) / 4.0D);
					HeightData.Height[Y, X] = System.Convert.ToInt64(System.Convert.ToInt32(Mean + ((int) (VBMath.Rnd() * Variation))) - VariationHalved);
				}
			}
			...
			for (Y = 1; Y <= HeightData.SizeY - 2; Y++)
			{
				...
				{
					Mean = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToInt32(HeightData.Height[Y - 1, X] + HeightData.Height[Y, X - 1]) + HeightData.Height[Y, X + 1] + HeightData.Height[Y + 1, X]) / 4.0D);
					HeightData.Height[Y, X] = System.Convert.ToInt64(System.Convert.ToInt32(Mean + ((int) (VBMath.Rnd() * Variation))) - VariationHalved);
				}
			}
			//top side points
			...
			for (X = 1; X <= HeightData.SizeX - 2; X += 2)
			{
				Mean = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToInt32(HeightData.Height[Y, X - 1] + HeightData.Height[Y, X + 1]) + HeightData.Height[Y + 1, X]) / 3.0D);
				HeightData.Height[Y, X] = System.Convert.ToInt64(System.Convert.ToInt32(Mean + ((int) (VBMath.Rnd() * Variation))) - VariationHalved);
			}
			//left side points
			X = 0;
			for (Y = 1; Y <= HeightData.SizeY - 2; Y += 2)
			{
				Mean = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToInt32(HeightData.Height[Y - 1, X] + HeightData.Height[Y, X + 1]) + HeightData.Height[Y + 1, X]) / 3.0D);
				HeightData.Height[Y, X] = System.Convert.ToInt64(System.Convert.ToInt32(Mean + ((int) (VBMath.Rnd() * Variation))) - VariationHalved);
			}
			//right side points
			...
			for (X = 1; X <= HeightData.SizeX - 2; X += 2)
			{
				Mean = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToInt32(HeightData.Height[Y - 1, X] + HeightData.Height[Y, X - 1]) + HeightData.Height[Y, X + 1]) / 3.0D);
				HeightData.Height[Y, X] = System.Convert.ToInt64(System.Convert.ToInt32(Mean + ((int) (VBMath.Rnd() * Variation))) - VariationHalved);
			}
		}
		...
		public void Multiply2(clsHeightmap SourceA, clsHeightmap SourceB)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToDouble(SourceA.HeightData.Height[Y, X] * SourceA.HeightScale) * SourceB.HeightData.Height[Y, X]) * SourceB.HeightScale) / HeightScale);
				}
			}
		}
		...
		public void Multiply(clsHeightmap Source, double Multiplier)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(Source.HeightData.Height[Y, X] * dblTemp);
				}
			}
		}
		...
		public void Divide2(clsHeightmap SourceA, clsHeightmap SourceB)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(SourceA.HeightData.Height[Y, X] / SourceB.HeightData.Height[Y, X]) * dblTemp);
				}
			}
		}
		...
		public void Intervalise(clsHeightmap Source, double Interval)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
				    HeightData.Height[Y, X] = System.Convert.ToInt32( System.Convert.ToDouble( Conversion.Int( Source.HeightData.Height[Y, X] * dblTemp ) ) * dblTemp2 );
				}
			}
		}
		...
		public void Add2(clsHeightmap SourceA, clsHeightmap SourceB)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(SourceA.HeightData.Height[Y, X] * dblTempA) + System.Convert.ToDouble(SourceB.HeightData.Height[Y, X] * dblTempB));
				}
			}
		}
		...
		public void Add(clsHeightmap Source, double Amount)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToDouble(Source.HeightData.Height[Y, X] * Source.HeightScale) + Amount) / HeightScale);
				}
			}
		}
		...
		public void Highest2(clsHeightmap SourceA, clsHeightmap SourceB)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					dblTempA = System.Convert.ToDouble(SourceA.HeightData.Height[Y, X] * dblTempC);
					dblTempB = System.Convert.ToDouble(SourceB.HeightData.Height[Y, X] * dblTempD);
		...
		public void Highest(clsHeightmap Source, double Value)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					dblTemp3 = System.Convert.ToDouble(Source.HeightData.Height[Y, X] * dblTemp);
		...
		public void Swap3(clsHeightmap SourceA, clsHeightmap SourceB, clsHeightmap Swapper)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					Ratio = System.Convert.ToDouble(Swapper.HeightData.Height[Y, X] * Swapper.HeightScale);
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToDouble(SourceA.HeightData.Height[Y, X] * SourceA.HeightScale) * (1.0D - Ratio) + System.Convert.ToDouble(SourceB.HeightData.Height[Y, X] * Ratio * SourceB.HeightScale)) / HeightScale);
				}
			}
		}
		...
		public void Clamp(clsHeightmap Source, double HeightMin, double HeightMax)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					dblTemp = System.Convert.ToDouble(Source.HeightData.Height[Y, X] * Source.HeightScale);
		...
		public void WaveLow(clsHeightmap Source)
		{
			...
			HeightRange = System.Convert.ToInt64(MinMax.Max - MinMax.Min);
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = (int) (((1.0D - Math.Sin((1.0D - System.Convert.ToInt32(Source.HeightData.Height[Y, X] - HeightMin) / HeightRange) * modMath.RadOf90Deg)) * HeightRange + HeightMin) * Source.HeightScale / HeightScale);
				}
			}
		}
		...
		public void WaveHigh(clsHeightmap Source)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = (int) ((Math.Sin(System.Convert.ToDouble(System.Convert.ToInt32(System.Convert.ToDouble(Source.HeightData.Height[Y, X] - HeightMin) / HeightRange) * modMath.RadOf90Deg)) * HeightRange + HeightMin) * Source.HeightScale / HeightScale);
				}
			}
		}
		...
		public void Rescale(clsHeightmap Source, double HeightMin, double HeightMax)
		{
			...
			SizeCopy(Source);
			HeightRange = System.Convert.ToInt64(MinMax.Max - MinMax.Min);
			Offset = System.Convert.ToInt64(0 - MinMax.Min);
			if (HeightRange > 0)
			{
				...
				for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
				{
					for (X = 0; X <= HeightData.SizeX - 1; X++)
					{
						HeightData.Height[Y, X] = System.Convert.ToInt64(lngTemp + System.Convert.ToInt32(System.Convert.ToDouble(Offset + Source.HeightData.Height[Y, X]) * Ratio));
					}
				}
			}
			else
		...
		public void ShiftToZero(clsHeightmap Source)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(Offset + Source.HeightData.Height[Y, X]) * dblTemp);
				}
			}
		}
		...
		public modProgram.sResult Load_Image(string Path)
		{
			...
			for (Y = 0; Y <= HeightmapBitmap.Height - 1; Y++)
			{
				...
				{
					System.Drawing.Color with_1 = HeightmapBitmap.GetPixel(X, Y);
					HeightData.Height[Y, X] = System.Convert.ToInt32(((with_1.R) + with_1.G + with_1.B) / (3.0D * HeightScale));
				}
			}
					...
					for (NewPixelY = (int)OldPixStartY; NewPixelY <= (int) (-(-OldPixEndY)); NewPixelY++)
					{
						...
						for (NewPixelX = (int)OldPixStartX; NewPixelX <= (int) (-(-OldPixEndX)); NewPixelX++)
						{
							...
							else
							{
								...
								HeightData.Height[NewPixelY, NewPixelX] = System.Convert.ToInt32(HeightData.Height[NewPixelY, NewPixelX] + System.Convert.ToInt32(hmSource.HeightData.Height[OldPixelY, OldPixelX] * Ratio * Temp));
							}
						}
					}
				}
		...
		public void FadeMultiple(clsHeightmap hmSource, sHeightmaps AlterationMaps, sHeights AlterationHeights)
		{
			...
			for (Y = 0; Y <= HeightData.SizeY - 1; Y++)
			{
				for (X = 0; X <= HeightData.SizeX - 1; X++)
				{
					srcHeight = System.Convert.ToSingle(hmSource.HeightData.Height[Y, X] * hmSource.HeightScale);
					...
					if (Level == 0)
					{
						HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(AlterationMaps.Heightmaps[Level].HeightData.Height[Y, X] * AlterationMaps.Heightmaps[Level].HeightScale) / HeightScale);
					}
					else if (Level > AlterationHeight_Ubound)
					{
						HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(AlterationMaps.Heightmaps[AlterationHeight_Ubound].HeightData.Height[Y, X] * AlterationMaps.Heightmaps[AlterationHeight_Ubound].HeightScale) / HeightScale);
					}
					else
					{
						intTemp = Level - 1;
						...
						HeightData.Height[Y, X] = System.Convert.ToInt32(System.Convert.ToDouble(System.Convert.ToDouble(AlterationMaps.Heightmaps[intTemp].HeightData.Height[Y, X] * AlterationMaps.Heightmaps[intTemp].HeightScale * (1.0F - Ratio)) + System.Convert.ToDouble(AlterationMaps.Heightmaps[Level].HeightData.Height[Y, X] * AlterationMaps.Heightmaps[Level].HeightScale * Ratio)) / HeightScale);
					}
				}
			}
		}
