...
namespace SharpFlame
{
	public sealed class modProgram
	{
		...
		public static void SetProgramSubDirs()
		{
			...
			MyDocumentsProgramPath = (new Microsoft.VisualBasic.Devices.ServerComputer()).FileSystem.SpecialDirectories.MyDocuments + System.Convert.ToString(PlatformPathSeparator) + ".flaME";
#if !Portable
...
#endif
			InterfaceImagesPath = (new Microsoft.VisualBasic.ApplicationServices.ConsoleApplicationBase()).Info.DirectoryPath + System.Convert.ToString(PlatformPathSeparator) + "interface" + System.Convert.ToString(PlatformPathSeparator);
		}
		...
		public readonly static System.Text.UTF8Encoding UTF8Encoding = new System.Text.UTF8Encoding(false, false);
		public readonly static System.Text.ASCIIEncoding ASCIIEncoding = new System.Text.ASCIIEncoding();
		...
		public static void ErrorIDChange(UInt32 IntendedID, clsMap.clsUnit IDUnit, string NameOfErrorSource)
		{
			...
			MessageText = "An object\'s ID has been changed unexpectedly. The error was in " + System.Convert.ToString(ControlChars.Quote) + NameOfErrorSource + System.Convert.ToString(ControlChars.Quote) + "." + ControlChars.CrLf + ControlChars.CrLf + "The object is of type " + IDUnit.Type.GetDisplayTextCode() + " and is at map position " + IDUnit.GetPosText() + ". It\'s ID was " + modIO.InvariantToString_uint(IntendedID) + ", but is now " + modIO.InvariantToString_uint(IDUnit.ID) + "." + ControlChars.CrLf + ControlChars.CrLf + "Click Cancel to stop seeing this message. Otherwise, click OK.";
		...
		public static void ZeroIDWarning(clsMap.clsUnit IDUnit, UInt32 NewID, clsResult Output)
		{
			...
			MessageText = "An object\'s ID has been changed from 0 to " + modIO.InvariantToString_uint(NewID) + ". Zero is not a valid ID. The object is of type " + IDUnit.Type.GetDisplayTextCode() + " and is at map position " + IDUnit.GetPosText() + ".";
